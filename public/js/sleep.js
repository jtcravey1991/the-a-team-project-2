let sleepLogChart = document.getElementById("myChart").getContext("2d");
...
document.getElementById("sleepHoursGoal").innerHTML = "You've set a goal for " + sleepGoal + " hours per night";
//Global options
...
let sleepChart = new Chart(sleepLogChart, {
    type: "bar",
    data: {
        labels: [],
        datasets: [{
...
function addSleep() {
    let logDate = document.getElementById("startOne").valueAsDate;
    ...
    if (sleepHours < sleepGoal) {
        ...
        document.getElementById("sleepProgress").innerHTML = "You must feel well rested!"
    };
